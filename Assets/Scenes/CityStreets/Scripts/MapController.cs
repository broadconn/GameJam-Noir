...
public class MapController : MonoBehaviour {
    ...
    private void SetupMap() {
        ...
        mapCursor.EmphasizeDir(GetNextStoryDir(_curNode, nextStoryId));
    }
    ...
    ArrowDir? GetNextStoryDir(MapNode curNode, StoryId nextStoryId) {
        ...
        var destinationNode = nodeNodes.Where(n => n.Node != null)
            .FirstOrDefault(n => n.Node.CitySpawnLocation == nextStoryId); // for now we can guarantee all story nodes link to each other :)
